...
def Process(filePath, savePath):
    ...
    cv2.imwrite(savePath, img_amsrcr)
# ------------------------------------------------------------#
# SSR
# retinex SSR
# # 用data数组里的最小数替代0
...
def changeImage():
    filePath = r'C:\PLY\Graduation Design\HOG_SVM-master\image\test_DJ_resize_new'
    destPath = r'C:\PLY\Graduation Design\HOG_SVM-master\image\test_DJ_retinex'
