...
# 训练集图片的位置
train_image_path = r'C:\PLY\Graduation Design\HOG_SVM-master\image\train_DJ_retinex'
# 测试集图片的位置
test_image_path = r'C:\PLY\Graduation Design\HOG_SVM-master\image\test_DJ_retinex'

# 训练集标签的位置
# train_label_path = os.path.join('image128','train.txt')
train_label_path = 'C:/PLY/Graduation Design/HOG_SVM-master/label/train_DJ.txt'
# 测试集标签的位置
# test_label_path = os.path.join('image128','train.txt')
test_label_path = 'C:/PLY/Graduation Design/HOG_SVM-master/label/test_DJ.txt'
