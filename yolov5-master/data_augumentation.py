...
import cv2
import numpy as np
imageDir="C:/PLY/Graduation Design/yolov5-master/own_datas/images/DJ_loose_bolt/test/test_image_abnormal"     #要改变的图片的路径文件夹
saveDir="C:/PLY/Graduation Design/yolov5-master/own_datas/images/DJ_loose_bolt/test_aug"   #要保存的图片的路径文件夹
