...
class MyMainWindow(QMainWindow, Ui_MainWindow):  # 继承 QMainWindow 类和 Ui_MainWindow 界面类
    ...
    def click_pushButton_02(self):  # 点击 pushButton_02 触发
        ...
        self.stackedWidget.setCurrentIndex(0)  # 打开 stackedWidget > page_0
        self.label_1.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_2.jpg"))
        return
    ...
    def click_pushButton_03(self):  # 点击 pushButton_03 触发
        ...
        self.label_1.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_3.jpg"))
        return

    def click_pushButton_04(self):  # 点击 pushButton_04 触发
        self.lineEdit.setText("1. 几何变换")
        self.plainTextEdit.appendPlainText("1.4 图像旋转")
        self.label_1.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_4.jpg"))
        return
    ...
    def click_pushButton_05(self):  # 点击 pushButton_05 触发
        ...
        self.label_2.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_1.jpg"))
    ...
    def click_pushButton_06(self):  # 点击 pushButton_06 触发
        ...
        self.label_3.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_2.jpg"))
        return

    def click_pushButton_07(self):  # 点击 pushButton_07 触发
        self.plainTextEdit.appendPlainText("2.3 图像平滑")
        self.label_2.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_3.jpg"))
        return

    def click_pushButton_08(self):  # 点击 pushButton_08 触发
        self.plainTextEdit.appendPlainText("2.4 图像锐化")
        self.label_3.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_4.jpg"))
        return
    ...
    def click_pushButton_09(self):  # 点击 pushButton_09 触发
        ...
        self.label_4.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_1.jpg"))
        self.label_5.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_2.jpg"))
        self.label_6.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_3.jpg"))
        self.label_7.setPixmap(QtGui.QPixmap("C:/PLY/Graduation Design/test_4.jpg"))
        return
