...
class MyMainWindow(QMainWindow, Ui_MainWindow):  # 继承 QMainWindow 类和 Ui_MainWindow 界面类
    ...
    def click_pushButton_1(self):  # 选择文件夹
        ...
        shutil.rmtree(r'C:\PLY\Graduation Design\software_GUI\image_process')
        os.mkdir(r'C:\PLY\Graduation Design\software_GUI\image_process')
        # 清空文件夹
    ...
    def click_pushButton_2(self):
        ...
        self.lineEdit_2.setText(image_id)
...
if __name__ == '__main__':  #
    ...
    myWin = CandyWindow.createWindow(myWin, 'blueDeep')
