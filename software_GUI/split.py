...
output_path = r'C:\PLY\Graduation Design\software_GUI\save'

def main():
    # yolo标签目录
    path_root_labels = r'C:\PLY\Graduation Design\software_GUI\exp\labels'
    # 图像目录
    path_root_imgs = r'C:\PLY\Graduation Design\software_GUI\image_process'
    #标签文件类型
    type_object = '.txt'
    # 图像文件类型
    type_img = 'jpg'
                    ...
                    if line:
                        ...
                        for idx in cls_idx:
                            if idx == cls:
                                flag = 1
                                if idx == 0:
                                    output_path = r'C:\PLY\Graduation Design\software_GUI\save\0'
                                if idx == 1:
                                    output_path = r'C:\PLY\Graduation Design\software_GUI\save\1'
                                if idx == 2:
                                    output_path = r'C:\PLY\Graduation Design\software_GUI\save\2'
                                if idx == 3:
                                    output_path = r'C:\PLY\Graduation Design\software_GUI\save\3'
                                if idx == 4:
                                    output_path = r'C:\PLY\Graduation Design\software_GUI\save\4'
                                if idx == 5:
                                    output_path = r'C:\PLY\Graduation Design\software_GUI\save\5'
                        if flag == 0:
                            continue
